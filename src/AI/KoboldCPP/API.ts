namespace AI.KoboldCPP
{
    export class API implements AI.API
    {
        ...
        public async generateText(prompt: string, schema: any): Promise<string>
        {
            ...
            const grammar = await this.generateGrammar(schema);
            const p = prompt.trim();
        ...
        public async generateInteractions(messages: Message[], schema: any): Promise<string>
        {
            ...
            console.log("generateInteractions (output)", output);
